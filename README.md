...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/wild-resonance-f51c#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wild-resonance-f51c
```

A live public deployment of this template is available at [https://wild-resonance-f51c.templates.workers.dev](https://wild-resonance-f51c.templates.workers.dev)
